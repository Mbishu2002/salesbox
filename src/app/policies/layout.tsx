  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 lg:p-16 border border-gray-100">
          <div className="prose prose-lg hover:prose-a:text-blue-600 prose-a:transition-colors">
